...
public class Graph
{
	...
	//Adiciona o Node do waypoint, ele destroi o collider e o renderer quando iniciar  o jogo
	...
	//A direção dos gameobject, ele adiciona atraves do Link
	...
	//Devolve a lista de PathList, para fazer o Player andar na verificação do FollowPath
	public int getPathLength()
	{
		return pathList.Count;	
	}
	//Pega o pronto que esta no momento no Pathlist, que é um array de gameobject
	public GameObject getPathPoint(int index)
	{
		return pathList[index].id;
	}
	
	//Apenas um Debug, que serve para tirar um print da lista de gameobjects e o seu nome que são o caminho que o tank vai fazer
